#ifndef kimm_franka_gui__FrankaGUI_H
#define kimm_franka_gui__FrankaGUI_H
...
#include "kimm_franka_gui/ui_kimm_franka_gui.h"
...
{
    class FrankaGui : public rqt_gui_cpp::Plugin
    {
        Q_OBJECT
    public:
        FrankaGui();
    ...
    protected slots:
        ...
        virtual void Jointcb(const sensor_msgs::JointStateConstPtr &msg){
            ui_.robot_p3->setText(QString::number(msg->position[0] * DEGREE , 'f', 3));
            ui_.robot_p4->setText(QString::number(msg->position[1] * DEGREE , 'f', 3));
            ui_.robot_p5->setText(QString::number(msg->position[2] * DEGREE , 'f', 3));
            ui_.robot_p6->setText(QString::number(msg->position[3] * DEGREE , 'f', 3));
            ui_.robot_p7->setText(QString::number(msg->position[4] * DEGREE , 'f', 3));
            ui_.robot_p8->setText(QString::number(msg->position[5] * DEGREE , 'f', 3));
            ui_.robot_p9->setText(QString::number(msg->position[6] * DEGREE , 'f', 3));

            ui_.robot_v3->setText(QString::number(msg->velocity[0] * DEGREE , 'f', 3));
            ui_.robot_v4->setText(QString::number(msg->velocity[1] * DEGREE , 'f', 3));
            ui_.robot_v5->setText(QString::number(msg->velocity[2] * DEGREE , 'f', 3));
            ui_.robot_v6->setText(QString::number(msg->velocity[3] * DEGREE , 'f', 3));
            ui_.robot_v7->setText(QString::number(msg->velocity[4] * DEGREE , 'f', 3));
            ui_.robot_v8->setText(QString::number(msg->velocity[5] * DEGREE , 'f', 3));
            ui_.robot_v9->setText(QString::number(msg->velocity[6] * DEGREE , 'f', 3));
    ...
    protected slots:
        ...
        virtual void jointctrlcb(){
            ...
            int node_num_ = plan_joint_srv_.response.res_traj.size() -1;
            ROS_WARN("%d", node_num_);
